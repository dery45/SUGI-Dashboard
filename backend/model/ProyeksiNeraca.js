...
const schema = new mongoose.Schema(
  {
    ...
    ketersediaan: { type: Number, required: true },
    kebutuhan: { type: Number, required: true },
    neraca: { type: Number, required: true },
...
module.exports = mongoose.models.ProyeksiNeraca || mongoose.model('ProyeksiNeraca', schema);
